                ...
                <tbody> 
                    ...
                    <tr> 
                        ...
                        <td> 
                            ...
                            <a href="<?= base_url('buku/hapusbuku/').$b['id_kategori'];?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul.' '.$b['nama_kategori'];?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a> 
                        </td> 
                    </tr> 
                    <?php } ?>
                </tbody> 
